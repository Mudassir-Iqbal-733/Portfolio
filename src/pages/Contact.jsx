...
{
    contacts.map((e,id)=>(
        <div data-aos="flip-up" key={id} className='flex gap-3 md:gap-7 mb-7 bg-gray-800/50 p-3 rounded-xl hover:bg-gray-700'>
       ...
       <div className='bg-gray-800/50 h-[93%] rounded-lg py-15 px-10 md:px-15 hover:bg-gray-700' data-aos="flip-up">
